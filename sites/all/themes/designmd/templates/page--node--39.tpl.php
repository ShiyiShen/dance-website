...
<?php if ($page['featured']): ?><div class="welcome"><?php print render($page['featured']); ?></div><?php endif; ?>
   <!-- 
    <img style="position:absolute;bottom:-50px;left:-170px;" src="/<?php print drupal_get_path('theme', 'designmd');?>/images/bg/dance-character.png" alt="dance character"/>
   -->
	<?php print $messages; ?>
    ...
    <div id="page" class="alignleft">         
        ...
        <!--BEGIN: customize content-->
           <?php //print render($page['content']); ?>
        <?php 
        $result = db_query('SELECT body_value FROM field_data_body WHERE entity_id = 39');
        ...
        <div id="yanlaiwu">
	        <div id="introduction">
	        	<img src="<?php print $image_path;?>/yanlaiwu2.png" width="65%" height="65%" style="float:left;margin:0 20px 20px 0;"/>
       		...
       		<table>
				<tr><td>
					<div class="report odd">
						<img class="source" src="<?php print $image_path;?>/postgazettelogo.jpg" />
				...
				<tr><td>				
					<div class="report even">
						<img class="source" src="<?php print $image_path;?>/wqed.png" /> 
